...
// Seizoen 2026-2027 — nog geen gespeelde wedstrijden (jun 2026)
const CURRENT_SEASON_PAST_MATCHES = [];

// Archief vorige seizoenen
...
function getMatchesForSeason(seasonKey) {
    if (seasonKey === CURRENT_SEASON_LABEL) {
        return CURRENT_SEASON_PAST_MATCHES;
    }
    return ARCHIVED_SEASONS[seasonKey]?.matches || [];
}

window.CURRENT_SEASON_LABEL = CURRENT_SEASON_LABEL;
window.CURRENT_SEASON_START = CURRENT_SEASON_START;
window.CURRENT_SEASON_PAST_MATCHES = CURRENT_SEASON_PAST_MATCHES;
window.ARCHIVED_SEASONS = ARCHIVED_SEASONS;
window.UPCOMING_MATCHES = UPCOMING_MATCHES;
window.TEAM_INFO = TEAM_INFO;
window.getMatchesForSeason = getMatchesForSeason;
// Compatibilidad
window.PAST_MATCHES = CURRENT_SEASON_PAST_MATCHES;
